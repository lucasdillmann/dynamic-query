 ...
 */
internal class NotEqualsCaseInsensitiveBinarySpecification(target: Parameter, value: Parameter):
    BinarySpecification(target, value, caseInsensitive("notEqual", CriteriaBuilder::notEqual))
