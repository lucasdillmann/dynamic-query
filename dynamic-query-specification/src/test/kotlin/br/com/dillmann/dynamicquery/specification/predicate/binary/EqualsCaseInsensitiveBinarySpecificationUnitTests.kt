...
/**
 * [EqualsCaseInsensitiveBinarySpecification] unit tests
 */
class EqualsCaseInsensitiveBinarySpecificationUnitTests {
    ...
    private val specification = EqualsCaseInsensitiveBinarySpecification(attributeName, value)
    ...
    fun setUp() {
        ...
        every { builder.equal(any<Expression<Any>>(), any<Expression<String>>()) } returns predicate
    ...
    fun `toPredicate should resolve and use the target using given Parameter`() {
        ...
        verify { builder.equal(lowerExpression, any()) }
    }

    @Test
    fun `toPredicate should parse the value to the target type using the given Parameter`() {
        // execution
        specification.toPredicate(root, query, builder)
        ...
        verify { builder.equal(any(), lowerExpression) }
    }
    ...
    fun `toPredicate should create and return the expected predicate`() {
        ...
        verify { builder.equal(any<Expression<String>>(), any<Expression<String>>()) }
    }
}
