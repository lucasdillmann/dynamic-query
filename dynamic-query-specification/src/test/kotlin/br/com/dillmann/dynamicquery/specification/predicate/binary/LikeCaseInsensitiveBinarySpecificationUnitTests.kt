...
/**
 * [LikeCaseInsensitiveBinarySpecification] unit tests
 */
class LikeCaseInsensitiveBinarySpecificationUnitTests {
    ...
    private val specification = LikeCaseInsensitiveBinarySpecification(attributeName, value)
    ...
    fun `toPredicate should resolve and use the target using given Parameter`() {
        ...
        verify { builder.like(lowerExpression, any<Expression<String>>()) }
    }
    ...
    fun `toPredicate should parse the value to the target type using given Parameter`() {
        ...
        verify { builder.like(any(), lowerExpression) }
    }
