...
class GreaterThanOrEqualsBinarySpecificationUnitTests {
    ...
    fun setUp() {
        ...
        every { builder.greaterThanOrEqualTo(any<Expression<Long>>(), any<Expression<Long>>()) } returns predicate
    ...
    fun `toPredicate should resolve and use the target using given Parameter`() {
        ...
        verify { builder.greaterThanOrEqualTo(path, any<Expression<Long>>()) }
    }
    ...
    fun `toPredicate should parse the value to the target type using given Parameter`() {
        ...
        verify { builder.greaterThanOrEqualTo(any(), valueExpression) }
    }
    ...
    fun `toPredicate should create and return the expected predicate`() {
        ...
        verify { builder.greaterThanOrEqualTo(any<Expression<Long>>(), any<Expression<Long>>()) }
    }
}
