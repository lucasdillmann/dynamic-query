...
/**
 * [IsEmptyUnarySpecification] unit tests
 */
class IsEmptyUnarySpecificationUnitTests {
    ...
    private val specification = IsEmptyUnarySpecification(attributeName)
    ...
    fun setUp() {
        ...
        every { builder.isEmpty(any<Path<Collection<Any>>>()) } returns predicate
    }
