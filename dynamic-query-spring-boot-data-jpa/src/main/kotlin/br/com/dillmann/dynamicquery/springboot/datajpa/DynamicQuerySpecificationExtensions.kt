 ...
 */
fun <T : Any> DynamicQuerySpecification?.toSpringSpecification(): Specification<T> =
 ...
 * restrictions) will be used as the argument for the [supplier].
 *
 * @param T Generic type of the specification's target entity
 * @param supplier Specification transformer able to customize the generated [Specification] from the
 ...
 */
fun <T : Any> DynamicQuerySpecification?.toSpringSpecification(supplier: ScopeDownSupplier<T>): Specification<T> =
    supplier(toSpringSpecification())
